...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL, hasProtocol, withHttps, withoutProtocol, withLeadingSlash, withoutTrailingSlash, withBase, decodePath } from 'file:///Users/paymei/Documents/Development/github/dubaifw/node_modules/ufo/dist/index.mjs';
...
import devalue from 'file:///Users/paymei/Documents/Development/github/dubaifw/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$2 } from 'file:///Users/paymei/Documents/Development/github/dubaifw/node_modules/pathe/dist/index.mjs';
  ...
  "nuxt-simple-sitemap": {
    ...
    "sitemaps": {
      "sitemap.xml": {
        ...
        "route": "sitemap.xml",
        "defaults": {
          "lastmod": "2025-10-27T11:13:37+00:00"
        },
        "include": [],
        "exclude": [
          "/api/**",
...
const _xra9k3 = defineEventHandler(async (e) => {
  const siteConfig = useSiteConfig(e);
  const nitroOrigin = useNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _xTNdjC = defineEventHandler(async (e) => {
...
const handlers = [
  ...
  { route: '/__site-config__/debug.json', handler: _xra9k3, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _xTNdjC, lazy: false, middleware: false, method: undefined },
